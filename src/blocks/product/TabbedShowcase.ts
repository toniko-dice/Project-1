...
export const TabbedShowcase: Block = {
  ...
  fields: [
    ...
    },
    {
      ...
      options: [
        { label: 'Снимка с панел отстрани', value: 'side-panel' },
        { label: 'Снимка отгоре, раздели отдолу', value: 'image-top' },
        { label: 'Раздели над снимката', value: 'tabs-top' },
      ],
      admin: {
        description:
    ...
    },
    {
      ...
      minRows: 2,
      // Шест сцени при DELTA 3 Max Plus (кухня, хол, кемпер, офис, гараж, пералня).
      maxRows: 8,
      ...
      fields: [
        ...
        },
        {
          ...
          /*
            ...
            Редовете се пазят и когато подредбата е „снимка отгоре" и не ги
            показва. Иначе смяната на подредбата би изтрила въведените
            стойности и връщането назад би означавало да се пишат наново.
          */
          maxRows: 6,
